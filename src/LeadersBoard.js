...
const LeadersBoard = ({ setIsActive }) => {
  setIsActive = "board";
  ...
  return (
    <React.Fragment>
      <Container>
        <TableContainer component={Paper} sx={{ marginTop: "8rem" }}>
              ...
              {rows.map((row) => (
                <>
                  <TableRow key={row.name}>
                    ...
                    <TableCell align="center">{row.Total_ranking}</TableCell>
                    <TableCell align="center">{row.Total_Reviews}</TableCell>
